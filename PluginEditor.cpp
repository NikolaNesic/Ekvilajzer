    ...
    juce::Slider& slider)
{
    ...
    g.setColour(enabled ? Colours::black : Colours::darkgrey); // Colour(66, 162, 200) <- plavo
    g.fillEllipse(bounds);

    g.setColour(enabled ? Colour(66, 162, 200) : Colours::grey);
    ...
    bool shouldDrawButtonAsDown)
{
    ...
    if (auto* pb = dynamic_cast<PowerButton*>(&toggleButton))
    {
        ...
        auto color = toggleButton.getToggleState() ? Colours::black : Colours::black;// Colour(66, 162, 200);
...
void RotarySliderWithLabels::paint(juce::Graphics& g)
{
    ...
    g.setColour(Colours::white);// Colour(66, 162, 200);Colour(66, 162, 200));
...
//==============================================================================
ResponseCurveComponent::ResponseCurveComponent(EkvilajzerAudioProcessor& p) :
    audioProcessor(p),
...
void ResponseCurveComponent::paint(juce::Graphics& g)
{
    ...
    g.setColour(Colours::white);
    g.drawRoundedRectangle(getRenderArea().toFloat(), 1.f, 1.f);
}
...
void ResponseCurveComponent::drawBackgroundGrid(juce::Graphics& g)
{
    ...
    for (auto gDb : gain)
    {
        ...
        g.setColour(gDb == 0.f ? Colour(66, 162, 200) : Colours::darkgrey);
...
void ResponseCurveComponent::drawTextLabels(juce::Graphics& g)
{
    ...
    for (auto gDb : gain)
    {
        ...
        g.setColour(gDb == 0.f ? Colour(66, 162, 200) : Colours::lightgrey);
...
//==============================================================================
EkvilajzerAudioProcessorEditor::EkvilajzerAudioProcessorEditor(EkvilajzerAudioProcessor& p)
    ...
    */
    ...
    peakQualitySlider(*audioProcessor.apvts.getParameter("Peak Quality"), ""),
    lowCutFreqSlider(*audioProcessor.apvts.getParameter("LowCut Freq"), ""),
    highCutFreqSlider(*audioProcessor.apvts.getParameter("HighCut Freq"), ""),
    ...
    analyzerEnabledButtonAttachment(audioProcessor.apvts, "Analyzer Enabled", analyzerEnabledButton)
{
    ...
    lowCutSlopeSlider.labels.add({ 0.0f, "12db/Oct" });
    lowCutSlopeSlider.labels.add({ 1.f, "48db/Oct" });

    highCutSlopeSlider.labels.add({ 0.0f, "12db/Oct" });
    ...
    auto safePtr = juce::Component::SafePointer<EkvilajzerAudioProcessorEditor>(this);
...
EkvilajzerAudioProcessorEditor::~EkvilajzerAudioProcessorEditor()
{
...
//==============================================================================
void EkvilajzerAudioProcessorEditor::paint(juce::Graphics& g) //glavni paint
{
    using namespace juce;
    ...
    g.setColour(Colours::white);
    g.setFont(14);
    g.drawFittedText("HighPass", lowCutSlopeSlider.getBounds(), juce::Justification::centredBottom, 1);
    g.drawFittedText("Peak", peakQualitySlider.getBounds(), juce::Justification::centredBottom, 1);
    g.drawFittedText("LowPass", highCutSlopeSlider.getBounds(), juce::Justification::centredBottom, 1);

    g.setFont(20);
    g.drawFittedText("EQ", peakQualitySlider.getBounds().withY(6), Justification::centredTop, 1);
}

void EkvilajzerAudioProcessorEditor::resized()
{
    auto bounds = getLocalBounds();
    bounds.removeFromTop(4);
...
std::vector<juce::Component*> EkvilajzerAudioProcessorEditor::getComps()
{
    return
    {
        &peakFreqSlider,
